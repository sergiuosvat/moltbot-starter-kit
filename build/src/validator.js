...
const identityAbiJson = __importStar(
  require('./abis/identity-registry.abi.json'),
);
const validationAbiJson = __importStar(
  require('./abis/validation-registry.abi.json'),
);
class Validator {
  relayerUrl = null;
  relayerAddress = null;
  ...
  async registerAgent() {
    ...
    const tx = await factory.createTransactionForExecute(senderAddress, {
      contract: new sdk_core_1.Address(
